 ...
 * 
 * Run with: node scripts/fix-invalid-dates.js
 * 
 * This script:
...
const TABLE_SAS_TOKEN = '?se=2030-12-31T23%3A59%3A59Z&sp=raud&spr=https&sv=2019-02-02&tn=Patients&sig=eGPFXl2orGOl22HxLB5shJs5PbhW0TL8xpo3we5X8LI%3D';
...
function getEntityUrl(tableName, partitionKey, rowKey) {
...
async function getAllPatients() {
  ...
  let allPatients = [];
  let nextPartitionKey = undefined;
  let nextRowKey = undefined;
  let pageCount = 0;
...
async function updatePatientDate(patient) {
  try {
