...
module.exports = async function (context, req) {
    context.log('Gmail OAuth callback received');
...
<body>
    <script>
        ...
        const requestPath = (req.url || '').split('?')[0] || '/api/auth/google/callback';
...
<body>
    <script>
        ...
        if (!userInfoResponse.ok) {
            ...
            context.log(`Failed to get user info from Google: ${errorText}`);
            const errorHtml = `
<!DOCTYPE html>
<html>
<head>
